...
A web app made using `django` framework to get latest news everyday using [**News API**](https://newsapi.org).
...
## Setting up the Project
  ...
  * Fork the Repository.
  * Clone the repository to your local machine `$ git clone https://github.com/<your-github-username>/news-app.git`
  * Change directory to news-app `$ cd news-app`
